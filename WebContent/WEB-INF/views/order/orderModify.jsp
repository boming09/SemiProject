...
<body>
	...
	<!-- 				<div class="item">
        	...
        	<div class="od_tt">
        		...
        		<div class="o_item">
        			<span class="address name"><input type="text" name="order_name" value="${member.userName}" class="nm_area"></span>
        		</div>
        	</div>
        	...
        	<div class="od_tt">
        		...
        		<div class="o_item">
        			<span class="address name"><input type="text" name="receive_name" value="${ loginUser.getUserId()}" class="nm_area"> </span>
        		</div>
        	</div>
        	...
        	<div class="od_tt">
	        	...
	        	<span class="address name"><input type="tel" maxlength="11" name="phone"
											placeholder="${member.userPhone}" class="nm_area"></span>
        		</div>
        	</div>
