...
<head>
    ...
    <!-- 외부 스타일 시트 -->
    <link href="<%= request.getContextPath() %>/resources/css/mypage/mypage-orderChange.css" rel="stylesheet">
</head>
<body>
		...
		<div class="content">            
        	...
        	<div>
	            ...
	            <c:forEach var="change" items="${ changeList }">
		            <ul class="orderlist" onclick="myDetail(${ change.order_no })">
		            	<li class="date2">${ change.order_date }</li>
			            ...
			            <li class="change2" style="color:#D25832;">
			            	<c:choose>
				            	...
				            	<c:when test="${ change.orderchange == 20 }">교환요청</c:when>
				            	<c:otherwise>반품요청</c:otherwise>
			            	</c:choose>
			            </li>
		            </ul>
	            </c:forEach>
