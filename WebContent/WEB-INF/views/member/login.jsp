...
<body>    
    ...
    <fieldset class="lofd">
        <legend id="lolegend"></legend>
            ...
            <div class="imgdiv">
                <a href="#"><img class="naverlogo" src="<%= request.getContextPath() %>/resources/images/kwang/naver.jpg" alt="naver logo"></a>   
                <a href="#"><img class="kakaologo" src="<%= request.getContextPath() %>/resources/images/kwang/kakao.jpg" alt="kako logo"></a>
            </div>             
        </fieldset>
