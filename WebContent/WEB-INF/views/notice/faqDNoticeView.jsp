...
<body>
	...
	<div class="csarea wrapper">
		...
		<div class="content">
            ...
            <div class="top3_list" id="faqDtop">
            ...
            <div class="total_list" id="faqDtotal">
	            ...
	            <ul class="faq_paging">
					...
					<c:choose>
						<c:when test="${ pi.page > 1 }">
							<a href="${ contextPath }/faqD?page=${ pi.page - 1}&atype=14&btype=${ param.btype }">&lt;</a>
						</c:when>
						<c:otherwise>
							<a href="#">&lt;</a>
						</c:otherwise>
					...
					<c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
						<li>
							<c:choose>
								...
								<c:otherwise>
									<a href="${ contextPath }/faqD?page=${ p }&atype=14&btype=${ param.btype }">${ p }</a>
								</c:otherwise>
							</c:choose>
						</li>
					</c:forEach>
	...
	<c:if test="">
	 ...
	 <script>
		...
		function btypeChange() {
			location.href="${ contextPath }/faqD?atype=14&btype=" + $('.btype').val();
		}
