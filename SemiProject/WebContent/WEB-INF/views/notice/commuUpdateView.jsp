...
<!-- 외부 스타일 시트 -->
<link href="${ contextPath }/resources/css/notice/commuUpdate.css" rel="stylesheet">
...
<body>
	...
	<div class="csarea wrapper">
		...
		<div class="content">
            ...
            <form method="post" action="${ contextPath }/commu/update?commu_no=${ commu.commu_no }">
	            <div class="commu_area">소통 내역</div>
	            <div class="commu_conarea">
	                <table>
	                    <tr class="liarea">
	                        <th class="commu_title">제목</th>
	                        <td class="title"><input type="text" name="newTitle" class="titleInput" value="${ commu.ctitle }"></td>         
	                    ...
	                    <tr class="liarea2">
	                        ...
	                        <td class="ccontent" colspan="3"><textarea name="newContent" class="ccontentTextarea">${ commu.ccontent }</textarea></td>
	                    </tr>
	                </table>
	            </div>
	             
	            <div class="commu_btn">
	                <button type="button" onclick="location.href='${ contextPath }/commu/detail?commu_no=${ commu.commu_no }'">취소</button>
